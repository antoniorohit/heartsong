...
void interruptSetup(){     
  ...
  TCCR0A = 0x02;
  TCCR0B = 0x03; // these put the timer into CTC mode and set the prescaler to 256
  
  OCR0A = 0xF9; // timer0 counts to 124, then gets reset to 0
  
  TIMSK0 = 0x02; // enable interrupt on OCR0A match

//Read more: http://pulsesensor.proboards.com/thread/173?page=1#ixzz3WfOv9yz3 
